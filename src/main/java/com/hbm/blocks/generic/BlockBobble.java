...
//
//    //@Override
//    public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, int x, int y, int z, EntityPlayer player) {
//
//        TileEntityBobble entity = (TileEntityBobble) world.getTileEntity(BlockPos.ORIGIN);
//
//        if(entity != null) {
//            return new ItemStack(this, 1, entity.type.ordinal());
//        }
//
//        return super.getPickBlock(state,target, world, BlockPos.ORIGIN, player);
//    }
//
//    //@Override
...
//            this.writeToNBT(nbt);
//            return new SPacketUpdateTileEntity(this.xCoord, this.yCoord, this.zCoord, 0, nbt);
//        }
//
//        @Override
